...
xvalue(2:end-1, 2:end-1, 2:end-1, :) = im(:,:,:,1:3);
xvalue(1,2:end-1,2:end-1,:) = im(1,:,:,1:3);
xvalue(end,2:end-1,2:end-1,:) = im(end,:,:,1:3);
xvalue(:,1,:,:) = xvalue(:,2,:,:);
...
yvalue(2:end-1, 2:end-1, 2:end-1, :) = im(:,:,:,[2,4,5]);
yvalue(1,2:end-1,2:end-1,:) = im(1,:,:,[2,4,5]);
yvalue(end,2:end-1,2:end-1,:) = im(end,:,:,[2,4,5]);
yvalue(:,1,:,:) = yvalue(:,2,:,:);
...
zvalue(2:end-1, 2:end-1, 2:end-1, :) = im(:,:,:,[3,5,6]);
zvalue(1,2:end-1,2:end-1,:) = im(1,:,:,[3,5,6]);
zvalue(end,2:end-1,2:end-1,:) = im(end,:,:,[3,5,6]);
zvalue(:,1,:,:) = zvalue(:,2,:,:);
